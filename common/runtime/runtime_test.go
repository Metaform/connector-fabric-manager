...
func TestCheckRequiredParams(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			params:      []any{"key", false},
			expectError: false,
		},
		{
			name:        "multiple nil keys with valid values",
			params:      []any{nil, "value1", nil, "value2"},
			expectError: false,
		},
	}
...
func TestValidateParamsOddNumberCheck(t *testing.T) {
	...
	tests := []struct {
		...
		{"single param", []any{"key"}, 1},
		{"three params", []any{"key1", "value1", "key2"}, 3},
		{"five params", []any{"key1", "value1", "key2", "value2", "key3"}, 5},
	}
...
func TestValidateParamsNilValueCheck(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "nil at index 5",
			params:   []any{"key1", "value1", "key2", "value2", "key3", nil},
			errorMsg: "key3 not specified",
		},
		{
			name:     "multiple nils at odd indices",
			params:   []any{"key1", nil, "key2", nil, "key3", nil},
